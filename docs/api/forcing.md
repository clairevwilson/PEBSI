...
| `adjust_precipitation(forcings, point_attrs, params)` | Applies precipitation gradient with elevation |
...
| `apply_parameters(forcings, params)` | Applies wind factor, dust factor, and precipitation factor scalings |
