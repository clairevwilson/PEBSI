...
if plot_type == 'timeseries':
    plt.savefig(output_fp + f'{glacier}_{time_str}_deposition_timeseries.png', dpi=300, bbox_inches='tight')
elif plot_type == 'scatter':
    fig.suptitle(time_str.capitalize() + ' deposition sums (kg m$^{-2}$) for '+glac_name.capitalize()+' glacier')
    fig.supxlabel('MERRA-2 deposition')
    fig.supylabel('UK-ESM deposition', x=-0.02)
    plt.savefig(output_fp + f'{glacier}_{time_str}_deposition_1to1.png', dpi=300, bbox_inches='tight')
plt.show()