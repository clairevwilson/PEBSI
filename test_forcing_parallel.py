...
if args.site == 'KPS':
    ...
    args.startdate = '2015-08-01'
    args.enddate = '2025-05-01'
    eb_prms.bias_vars = ['wind']

# Loop through parameters
for var in vary:
    if var != 'temp':
        vary_by_list = vary_by 
    else:
        vary_by_list = vary_by_temp
    for bb, by in enumerate(vary_by_list):
        # Copy over args
        ...
        if var == 'rh':
            climate_run.cds['rh'] = climate_run.cds['rh'].clip(max=100)
